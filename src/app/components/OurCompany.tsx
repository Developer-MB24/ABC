...
const features = [
  {
    ...
    description:
      "Alienum phaedrum torquatos nec eu, vis detraxit periculis ex, nihil expetendis in mei. Mei an pericula euripidis, hinc partem ei est. Eos ei.",
  },
  {
    icon: <FaCog size={30} />,
    title: "New Features",
      ...
      <section className="py-16 px-5 bg-gray-50 text-gray-700">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 mb-12">
            Strategy Planning Lorem Ipsum sit dolor alienum phaedrum torquatos
            nece, vis detraxit periculais nihik dameri.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="text-center p-6 border rounded-lg shadow-sm bg-white"
              >
      ...
      <section className="py-16 px-10 bg-white text-gray-700">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              {
                icon: <FaRocket className="text-gray-800 text-3xl" />,
                title: "Outstanding Support",
              },
              {
                icon: <FaGem className="text-gray-800 text-3xl" />,
